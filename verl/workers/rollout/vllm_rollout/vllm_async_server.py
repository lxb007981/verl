...
class vLLMHttpServer:
    ...
    def _resolve_sleep_level(self) -> int:
        ...
        LoRA only updates adapter weights, so use sleep level 1.
        vllm_ascend does not support sleep levels yet. Enabling EP during training may lead to accuracy issues.
        """
